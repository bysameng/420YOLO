...
//					via the event system in a decoupled manner.
//					PLEASE NOTE: this class is only a placeholder for your 'real'
//					inventory system. implementation of inventory systems may differ
//					widely depending on your game design, your choice of database
//					and network solution and so on. the idea is that you should be
//					able to remove or rewrite this class while changing little or
//					no code in the classes that talk to it. study its use of the
//					event system to see how this would work.
//
/////////////////////////////////////////////////////////////////////////////////
...
public class vp_SimpleInventory : MonoBehaviour
{
	...
	protected virtual bool OnAttempt_AddAmmo(object arg)
	{
		...
		if (ammo == -1)
			...
			weapon.LoadedAmmo = Mathf.Min(ammo, weapon.MaxAmmo);	// add 'ammo' units, capping at max
