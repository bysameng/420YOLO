/////////////////////////////////////////////////////////////////////////////////
//
//	vp_PrototypeMeleeAttackEditor.cs
//	© VisionPunk, Minea Softworks. All Rights Reserved.
//	www.visionpunk.com
//
//	description:	custom inspector for the vp_PrototypeMeleeAttack class
//
/////////////////////////////////////////////////////////////////////////////////
...
[CustomEditor(typeof(vp_PrototypeMeleeAttack))]

public class vp_PrototypeMeleeAttackEditor : Editor
{

	// target component
	public vp_PrototypeMeleeAttack m_Component;
	...
	public virtual void OnEnable()
	{
		...
		m_Component = (vp_PrototypeMeleeAttack)target;
	...
	public virtual void DoWeaponStatesFoldout()
	{
		...
		if (m_WeaponStatesFoldout)
		{
			...
			m_Component.WeaponStateCharge = EditorGUILayout.TextField("Charge State", m_Component.WeaponStateCharge);
			m_Component.WeaponStateSwing = EditorGUILayout.TextField("Swing State", m_Component.WeaponStateSwing);

			GUILayout.BeginHorizontal();
			GUILayout.Space(10);
			EditorGUILayout.HelpBox("The melee attack will attempt to trigger these states on the vp_FPWeapon component in the same gameobject. First the Charge state will be triggerered, followed by a short delay and finally the Swing state.", MessageType.Info);
			GUILayout.Space(10);
	...
	public virtual void DoSwingFoldout()
	{
		...
		m_SwingFoldout = EditorGUILayout.Foldout(m_SwingFoldout, "Swing");
