...
public class vp_FPSDemo2 : MonoBehaviour
{
	...
	private Vector3 m_IcyRoofPos = new Vector3(115.3f, 113.3f, -86.5f);
	...
	private Vector2 m_IcyRoofAngle = new Vector2(30, 230);
	...
	bool m_Jump = false;
	int m_LookPoint = 0;
	private Vector3[] m_LookPoints = new Vector3[8];
	...
	void DemoPhysics()
	{
		...
		// 'go again' button
		if (m_Demo.ShowGUI && !m_GoAgainTimer.Active && m_Demo.ButtonSelection != 7)
		{
		...
		if (m_Demo.ButtonSelection != m_ExamplesCurrentSel)
		{
			...
			switch (m_Demo.ButtonSelection)
			{
				...
				case 1:
					...
					m_Demo.Teleport(m_IcyRoofPos, m_IcyRoofAngle);
				...
				case 2:
					...
					vp_Timer.In(6, delegate() { }, m_GoAgainTimer);
					break;
				case 3:
		...
		if (m_Demo.ButtonSelection != 2 && m_Demo.ButtonSelection != 7)
		{
			m_Demo.LockControls();
			m_Demo.Input.AllowGameplayInput = false;
		}
		else if (m_Demo.ButtonSelection != 7)
		{
			m_Demo.LockControls();
			m_Demo.Input.AllowGameplayInput = false;
		}
		...
		{
			m_ExamplesCurrentSel = m_Demo.ButtonSelection;
			string[] strings = new string[] { "Mud... or Slime", "Icy Roof", "Action Hero", "Head Bump", "Wall Deflection", "Fall Deflection", "Blown Away" }; m_Demo.ButtonSelection = m_Demo.ToggleColumn(140, 150, m_Demo.ButtonSelection, strings, false, true, ImageRightPointer, ImageLeftPointer);
		}
