...
public class vp_FPSDemo1 : MonoBehaviour
{
	...
	private void DemoIntro()
	{
		...
		m_Demo.DrawBoxes("welcome", "Ultimate FPS Camera is a NEXT-GEN first person camera system with ultra smooth PROCEDURAL ANIMATION of player movements. Camera and weapons are manipulated using over 100 parameters, allowing for a vast range of super-lifelike behaviors.", null, m_ImageRightArrow);
	...
	private void DemoWeaponLayer()
	{
		...
		if (m_Demo.ShowGUI)
		{
			...
			m_WeaponLayerToggle = m_Demo.ButtonToggle(new Rect((Screen.width / 2) - 45, 180, 90, 40), "Weapon Layer",
